...
function TermsOfService() {
    return(
        <main id="terms-of-service-body" className='body'>

            <Helmet>
                <title>Voice Rooms • Terms of Service</title>
            </Helmet>
            
            <h1 className='tos-title'>Terms of Service</h1>
            <div className='tos'>
                <p className='tos-last-updated'>Last updated April 20, 2023</p>
                <div data-custom-class="body">
                    ...
                    <div align="center" style={{'text-align': 'left'}}>
                        ...
                        <span style={{'font-size': '11.0pt', 'line-height': '115%', 'mso-themecolor': 'text1', 'mso-themetint': '166'}}>
                            We are Voice Rooms
                            (
                            "
                            <strong>
                            ...
                            <span style={{'font-size': '11.0pt', 'line-height': '115%', 'mso-fareast-color': '#595959', 'mso-themecolor': 'text1', 'mso-themetint': '166'}}>
                            <span style={{'font-size': '11.0pt', 'line-height': '115%', 'mso-fareast-color': '#595959', 'mso-themecolor': 'text1', 'mso-themetint': '166'}}>
                                <span style={{'font-size': '11.0pt', 'line-height': '115%', 'mso-fareast-color': '#595959', 'mso-themecolor': 'text1', 'mso-themetint': '166'}}>
                                <bdt class="question">
                                    <bdt class="block-component">
                    ...
                    <div align="center" style={{'text-align': 'left'}}>
                        <div class="MsoNormal" data-custom-class="body_text" style={{'line-height': '1.5'}}>
                        <span style={{'font-size': '11.0pt', 'line-height': '115%', 'mso-themecolor': 'text1', 'mso-themetint': '166'}}>
                            We operate the website <a data-custom-class="link" href="https://www.voicerooms.app/" target="_blank" rel="noreferrer">
                                https://www.voicerooms.app/
                            </a>
                            (the
                            "
                            <strong>
                        ...
                        <div class="MsoNormal" data-custom-class="body_text" style={{'line-height': '1.5'}}>
                        <bdt class="question">
                            We offer a Discord bot that will organize your Discord server's voice channels.
                        </bdt>
                        </div>
                        <div class="MsoNormal" data-custom-class="body_text" style={{'line-height': '1.5'}}>
                        <span style={{'font-size': '11.0pt', 'line-height': '115%', 'mso-themecolor': 'text1', 'mso-themetint': '166'}}>
                        ...
                        <div class="MsoNormal" data-custom-class="body_text" style={{'line-height': '1.5'}}>
                        <span style={{'font-size': '11.0pt', 'line-height': '115%', 'mso-themecolor': 'text1', 'mso-themetint': '166'}}>
                            You can contact us by email at voicerooms.contact@gmail.com
                            .
                        </span>
                        </div>
                        <div class="MsoNormal" style={{'line-height': '1'}}>
                ...
                received payment.
                            ...
                            <ul>
                                ...
                                <span style={{'font-size': '15px'}}>
                                    ...
                                    <span style={{'font-style': 'normal', 'font-variant-ligatures': 'normal', 'font-variant-caps': 'normal', 'font-weight': '400', 'letter-spacing': 'normal', 'orphans': '2', 'text-align': 'justify', 'text-indent': '-29.4px', 'text-transform': 'none', 'white-space': 'normal', 'widows': '2', 'word-spacing': '0px', '-webkit-text-stroke-width': '0px', 'text-decoration-style': 'initial', 'text-decoration-color': 'initial'}}>
                                        ...
                                        <span style={{'font-size': '11pt', 'line-height': '16.8667px', 'font-style': 'normal', 'font-variant-ligatures': 'normal', 'font-variant-caps': 'normal', 'font-weight': '400', 'letter-spacing': 'normal', 'orphans': '2', 'text-align': 'justify', 'text-indent': '-29.4px', 'text-transform': 'none', 'white-space': 'normal', 'widows': '2', 'word-spacing': '0px', '-webkit-text-stroke-width': '0px', 'text-decoration-style': 'initial', 'text-decoration-color': 'initial'}}>
                                                                                    </span>
                                        </span>
                                    </span>
                                    </span>
                    ...
                    <div class="MsoNormal" data-custom-class="body_text" style={{'line-height': '1.5', 'text-align': 'left'}}>
                        ...
                        <bdt class="block-container if" data-type="if" id="b86653c1-52f0-c88c-a218-e300b912dd6b">
                            <bdt data-type="conditional-block">
                                                        <bdt data-type="body">
                                the State of
                                <bdt class="block-container question question-in-editor" data-id="b61250bd-6b61-32ea-a9e7-4a02690297c3" data-type="question">
                                California
                                </bdt>
                            </bdt>
                            </bdt>
                    ...
                    <div class="MsoNormal" data-custom-class="body_text" style={{'line-height': '1.5', 'text-align': 'left'}}>
                        ...
                        To expedite resolution and control the cost of any dispute, controversy, or claim related to these Legal Terms (each a
                                                ...
                                                ), the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least 14
                    ...
                    <div class="MsoNormal" data-custom-class="body_text" style={{'line-height': '1.5', 'text-align': 'left'}}>
                        ...
                        <span style={{'font-size': '15px'}}>
                        If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved by binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration shall be commenced and conducted under the Commercial Arbitration Rules of the American Arbitration Association (
                                                "AAA"
                        ...
                        . Your arbitration fees and your share of arbitrator compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules.
                                                ...
                                                . Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter
                                                judgment
